...
\begin{tabular}{c|c|c}
\hline
编译方式 & 调用的宏包 & other\\ \hline
\XeLaTeX & xeCJK, CJKnumb, graphicx, mathptmx, amssymb,mathpazo,pgf,tikz & test\\ \hline
\end{tabular}
\end{center}
...
\begin{figure}
  ...
  \caption{\label{fig:nku} \kaiti{南开大学}}
\end{figure}
...
\begin{Theorem} \label{thm:la tex}
\LaTeX 的输出是最完美的.
\end{Theorem}
